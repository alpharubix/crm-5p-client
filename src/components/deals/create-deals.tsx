...
export default function CreateDeal() {
  ...
  const [debouncedSearch, setDebouncedSearch] = useState(prefilledData.accountName || '')
  ...
  const createMutation = useMutation({
    mutationFn: async (values: CreateDealFormValues) => {
      const payload: any = {
        ...
        ticket_number: values.ticketNumber ? String(values.ticketNumber) : undefined,
        ...
        targeted_disbursement_date: values.targetedDisbursementDate || undefined,
        ...
        customer_rejection_status_explanation: values.customerRejectionStatusExplanation || undefined,
        lender_rejection_reason: values.lenderRejectionReason || undefined,
        lender_rejection_status_explanation: values.lenderRejectionStatusExplanation || undefined,
      ...
      <Card>
        ...
        <CardContent className='p-0 grid grid-cols-1 md:grid-cols-2 border-b'>
          <div className='md:border-r'>
            ...
            <FieldRow label='Product' error={errors.product?.message}>
              <Input {...register('product')} placeholder='Product' className='h-8' />
            </FieldRow>

            <FieldRow label='Loan Type' error={errors.loanType?.message}>
              <SelectField
                isEdit={true}
                options={[
                  'SCF',
          ...
          <div>
            <FieldRow label='Ticket ID' error={errors.ticketId?.message}>
              <Input {...register('ticketId')} placeholder='Ticket ID' type='number' className='h-8' />
            </FieldRow>
            <FieldRow label='Ticket Number' error={errors.ticketNumber?.message}>
              <Input {...register('ticketNumber')} placeholder='Ticket Number' type='number' className='h-8' />
            </FieldRow>
        ...
        <SectionHeader title='Case Status & Timeline' />
        <CardContent className='p-0 grid grid-cols-1 md:grid-cols-2 border-b'>
          <div className='md:border-r'>
            ...
            <FieldRow label='Type of login' error={errors.typeOfLogin?.message}>
              <Input {...register('typeOfLogin')} placeholder='Type of login' className='h-8' />
            </FieldRow>
        ...
        <CardContent className='p-0 grid grid-cols-1 md:grid-cols-2 border-b'>
          <div className='md:border-r'>
            ...
            <FieldRow label='Tenure (Months)' error={errors.tenure?.message}>
        ...
        <SectionHeader title='Lender & Loan Term' />
        <CardContent className='p-0 grid grid-cols-1 md:grid-cols-2 border-b'>
          <div className='md:border-r'>
        ...
        <CardContent className='p-0 grid grid-cols-1 md:grid-cols-2'>
          <div className='md:border-r'>
            ...
            <FieldRow label='Customer Rejection Explanation' error={errors.customerRejectionStatusExplanation?.message}>
          ...
          <div>
            ...
            <FieldRow label='Lender Rejection Explanation' error={errors.lenderRejectionStatusExplanation?.message}>
