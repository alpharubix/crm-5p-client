      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white shadow-xl relative overflow-hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            {isAdmin && (
              <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-purple-500/20 text-purple-300 border border-purple-400/30 backdrop-blur-md flex items-center gap-1">
                <ShieldCheck className="w-3 h-3 text-purple-300" /> Admin Access
              </span>
            )}
          </div>
        ...
        <div className="flex items-center gap-3 relative z-10">
          <Button
            ...
            variant="outline"
            className="bg-white/10 hover:bg-white/20 text-white border-white/20 hover:border-white/30 backdrop-blur-md transition-all rounded-xl shadow-sm cursor-pointer"
          >
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-lg shadow-md shadow-blue-500/20 active:scale-[0.99] transition-all py-2.5 cursor-pointer"
              >
                {isSubmitting ? (
                  <>
                          ...
                          >
                            ...
                            <TableCell className="py-3.5">
                              {canManage ? (
                                ...
                                >
                                  <SelectTrigger className="h-8 text-xs font-semibold w-32 border-slate-200 rounded-lg shadow-none">
                                    {isUpdatingThis ? (
                            ...
                            <TableCell className="py-3.5 pr-6 text-right">
                              <Button
                                ...
                                size="sm"
                                onClick={() => setSelectedTicket(t)}
                                className="h-8 px-2.5 text-xs text-slate-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg cursor-pointer"
                                title="View Details"
                              >
