...
const CallRecordingsPage = lazy(() => import('./pages/call-recordings-page'))
const DealTasksPage = lazy(() => import('./pages/deal-tasks-page'))
        ...
        >
          <Routes>
            ...
            >
              ...
              <Route path='/deal-tasks' element={<DealTasksPage />} />
